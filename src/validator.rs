...
mod tests {
    ...
    fn test_prefix_validate() {
        let validator = AddressValidator::new(None, Some("123".to_string()), None, None);
        assert!(validator.validate("1230000000000000000000000000000000000000"));
        assert_eq!(
    ...
    fn test_suffix_validate() {
        let validator = AddressValidator::new(None, None, Some("123".to_string()), None);
    ...
    fn test_regex_validate() {
        let validator = AddressValidator::new(None, None, None, Some("0{10}".to_string()));
